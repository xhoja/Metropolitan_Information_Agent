...
Detailed use case diagrams for each user role are available in the project documentation at \texttt{/docs/diagrams/}:

\begin{itemize}
    \item \texttt{use-case-student.svg} - Student Portal Use Cases
    \item \texttt{use-case-professor.svg} - Professor Dashboard Use Cases
    \item \texttt{use-case-admin.svg} - Administrator Portal Use Cases
\end{itemize}

These diagrams illustrate the primary use cases and workflows for each user role, showing how students access grades and chat with M.I.A, how professors manage courses and grades, and how administrators oversee institutional operations.
...
Detailed process flow diagrams (BPMN notation) are available in the project documentation at \texttt{/docs/diagrams/}:

\begin{itemize}
    \item \texttt{M.I.A-Chat-Flow-BPMN.svg} - M.I.A Conversational Flow
    \item \texttt{Login-Flow-BPMN.svg} - Authentication and Login Flow
    \item \texttt{Assignment-Submission-BPMN.svg} - Assignment Submission and Grading
\end{itemize}

These diagrams show the detailed sequence of operations, decision points, and system interactions for critical workflows including user authentication, M.I.A chat interactions, and assignment submission processes.
